    ...
    <div className="bg-[#faf9f7] text-black font-sans">
      ...
      <div className="py-16 md:py-24 text-center border-b border-gray-100">
        ...
        <p className="text-[10px] tracking-[0.4em] uppercase text-gray-500 font-bold px-4">
          Premium Eyewear Experience & Support
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-24">
          <div className="text-center group">
            ...
            <p className="text-sm font-serif italic mb-1">0318-3140548</p>
          ...
          <div className="text-center group">
            ...
            <p className="text-sm font-serif italic mb-1">daniyalndaniyal1@gmail.com</p>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32 items-center">
          <div>
            <h2 className="text-2xl font-serif italic mb-6">Connect With Us</h2>
            <p className="text-gray-500 text-sm leading-relaxed mb-8 font-light">
              Whether you need eyewear consultation or help with your order, our optical specialists are here to assist you with expert guidance.
            </p>
          ...
          <div className="bg-[#F9F9F9] p-8 md:p-12 text-center flex flex-col items-center justify-center border border-gray-100 h-full min-h-100">
            <MapPin size={40} strokeWidth={1} className="mb-6 text-gray-300" />
            <h3 className="text-lg font-serif italic mb-4">Visit Our Showroom</h3>
