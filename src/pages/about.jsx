...
const About = () => {
  ...
  const shopImages = [
    { url: '/shop-1.jpeg', label: 'Frames Display', num: '01' },
    { url: '/shop-2.jpeg', label: 'Interior', num: '02' },
    { url: '/shop-3.jpeg', label: 'Interior', num: '03' },
    { url: '/shop-4.jpeg', label: 'Interior', num: '04' },
  ];
